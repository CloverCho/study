...
# We need to remove RISK_MM because we want to predict 'RainTomorrow' and RISK_MM can leak some
#  info to our model
...
# next step is to standardize our data - using MinMaxScalar
...
# now that we are done with the pre-processing part, let's see which are the important features
# for RainTomorrow!
